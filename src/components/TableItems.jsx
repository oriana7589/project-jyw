...
const TableItems = ({
  ...
  return (
    <div>
      {articuloSugeridoCliente.length>0&&articuloSugeridoClientePorMonto.length>0 ? (
 ...
 {lista2Filtrada.slice(0, 5).map((item, index) => (
   ...
   <Grid item xs={4} width={"100%"} key={index} style={{ flexBasis: "20%", boxSizing: "border-box" , marginTop:10}}>
     {" "}
     {/* Change xs to 6 */}
     <Paper
       elevation={3}
