...
import { descriItem, descripcionCont, descripcionItem, descripItem, itemComp, tableItem, tableItemColum, tableItemsCont } from "../../Styles/MenuStyles";
      ...
      <div style={{ width: "100%", paddingRight:10 }}>
        <div style={{ position: "sticky", top: 0, zIndex: 1 }}>
          ...
          >
            ...
            <tbody>
              <tr>
                <td style={{ ...descripcionItem, backgroundColor: "rgb(179,180,177)", width: 55}}></td>
                <td style={{...descripcionCont ,fontWeight: "bold" }}> Importado </td>
                <td style={{ width: 50 }}></td>
                <td style={{...descripcionItem,backgroundColor: "rgb(227,216,249)", width: 55 }}></td>
                <td style={{...descripcionCont ,fontWeight: "bold"}}> Importado</td>
                <td style={{}}></td>
                <td style={{...descripcionItem, backgroundColor: "rgb(29,241,255)",width: 55}} ></td>
                <td style={{...descripcionCont , fontWeight: "bold"}} >Precio Descuento</td>
                <td style={{}}></td>
              </tr>
            </tbody>
          </table>
        ...
        >
         {isLoading ? (
            ...
            <tr>
              <td colSpan="11" style={{ textAlign: "center", padding: "20px", fontStyle: "italic" }}>
              ...
              {productos
                ...
                .map((item, index) => (
                  ...
                  >
                    ...
                    <td style={{...descriItem,overflow: "auto",maxWidth: "320px",paddingLeft: 5}}>
                     <CustomScroll style={{ maxWidth: "320px", whiteSpace: "nowrap" }}>  {item.DescripcionArticulo}
                      </CustomScroll>
                    </td>
                    <td style={{ ...descripItem,   maxWidth: "75px",paddingLeft: 5}} >{item.DescripcionPais}</td>
                    <td style={{ ...descripItem,   maxWidth: "85px", paddingLeft: 5}}>{item.DescripcionMarca}</td>
                    <td style={{ ...descripItem, paddingLeft: 5, textAlign: "end"}} >{item.PrecioVenta} </td>
                    <td style={{...descripItem, maxWidth: "55px",paddingLeft: 5, textAlign: "end",background: "rgb(29,241,255)"}} >
                      {item.PrecioDescuento}</td>
                    <td style={{...descripItem, maxWidth: "30px",textAlign: "end", paddingLeft: 6.8}}>{item.Stock01P1}</td>
                    <td style={{...descripItem,  maxWidth: "30px", textAlign: "end",paddingLeft: 6.8}}> {item.Stock01P3}</td>
                    <td style={{...descripItem,  maxWidth: "30px",textAlign: "end",  paddingLeft: 6.8}} > {item.Stock01P4}</td>
                    <td style={{...descripItem,maxWidth: "30px", textAlign: "end"}}>{item.Stock02P1}</td>
                    <td style={{ ...descripItem, textAlign: "end", maxWidth: "30px",paddingLeft: 6.8}}> {item.StockT1P1} </td>
